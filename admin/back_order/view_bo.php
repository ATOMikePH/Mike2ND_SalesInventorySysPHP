            ...
            <table class="table table-striped table-bordered" id="list">
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <th class="text-right py-1 px-2 discount text-success"><?php echo isset($discount) ? number_format($discount, 2) : 0 ?></th>
                    </tr>
                    <tr>
                        <th class="text-right py-1 px-2" colspan="4">Tax <?php echo isset($tax_perc) ? $tax_perc : 0 ?>%</th>
                        <th class="text-right py-1 px-2 tax text-warning"><?php echo  isset($tax) ? number_format($tax,2) : 0 ?></th>
                    </tr>
                    <tr>
