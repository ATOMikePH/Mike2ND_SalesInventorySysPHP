...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4><i class="fas fa-shopping-cart icon"></i><?php echo isset($id) ? " POS Supplier Purchases - " . $po_code : ' POS Supplier Purchase' ?></h4>
    </div>
    <div class="card-body">
...
<style>
    ...
    <button class="btn btn-flat btn-primary" type="submit" form="po-form">
