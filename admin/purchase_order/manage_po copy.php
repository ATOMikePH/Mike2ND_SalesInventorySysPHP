...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4><i class="fas fa-shopping-cart icon"></i><?php echo isset($id) ? " Purchase Order Details - ".$po_code : ' Purchase Order Form Registration' ?></h4>
    </div>
    <div class="card-body">
                    ...
                    <div class="row justify-content-center align-items-end">
                            <?php 
                                ...
                                while($row=$item->fetch_assoc()):
                                    ...
                                    $cost_arr[$row['id']] = $row['supplier_price'];
                                endwhile;
                            ?>
                        <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control rounded-0" id="unit" placeholder="eg. 25L, PCS, 10KG, PC">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
