...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4><i class="fas fa-check icon"></i><?php echo !isset($id) ? " Receive Order from ".$po_code : ' Update Received Order' ?></h4>
    </div>
    <div class="card-body">
    ...
    <label for="transaction_datetime" class="control-label text-info">Received Date and Time</label>
...
<div class="col-md-6">
    ...
    <input type="text" name="input_by" class="form-control form-control-sm rounded-0" value="<?php echo isset($input_by) ? $input_by : ($_settings->userdata('salutation').' '.$_settings->userdata('firstname').' '.$_settings->userdata('lastname')); ?>" readonly>
</div>
                    <div class="col-md-6">
                        <div class="form-group">
                ...
                <table class="table table-striped table-bordered" id="list">
                    ...
                    <tbody>
                        ...
                        $qry = $conn->query("SELECT b.*,i.name,i.sku FROM `bo_items` b inner join item_list i on b.item_id = i.id where b.bo_id = '{$bo_id}'");
